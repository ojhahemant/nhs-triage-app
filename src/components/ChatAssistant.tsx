...
const ChatAssistant: React.FC<ChatAssistantProps> = ({ triageData, isOpen, onClose }) => {
  ...
  useEffect(() => {
    if (messages.length === 0) {setMessages([
        {
          role: 'assistant',
          content: `Hello, I'm your NHS Dermatology Triage assistant. I can help you understand the triage results and answer questions about the assessment${triageData.assessment.categorization ? ', including the AI-suggested case categorization' : ''}. How can I help you today?`
        }
      ]);    }
